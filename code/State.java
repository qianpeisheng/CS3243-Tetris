...
public class State {
	...
	/**
	  public State(State another) {
		    this.lost = another.lost;
		    this.label = another.label;
		    this.turn = another.turn;
		    this.cleared = another.cleared;
		    this.field = another.field;
		    this.top = another.top;
		    this.nextPiece = another.nextPiece;
		  }**/
	...
	public int[][] getFieldClone() {
		return field.clone();
	}
	
	public void setField(int[][] anotherField) {
		for(int i = 0; i < anotherField.length; i++) {
			for (int j = 0; j < anotherField[i].length; j ++) {
				int value = anotherField[i][j];
